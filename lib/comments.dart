...
*/
  ...
  //     minimumFetchInterval: 1440, // in minutes
  //     stopOnTerminate: false,
  //     startOnBoot: true,
  //   ),
  //   (String taskId) async {
  //     print("[BackgroundFetch] Task ID: $taskId");

  //     // Fetch the step count data
  //     Pedometer pedometer = Pedometer();
  //     Stream<StepCount> stepCountStream = Pedometer.stepCountStream;

  //     // Sum the step count data for the day
  //     int totalSteps = 0;
  ...
  //       if (stepCount.timeStamp.isBefore(startOfDay)) {
  //         break;
  //       }
  //     }
  //       if (totalSteps > 0) {
