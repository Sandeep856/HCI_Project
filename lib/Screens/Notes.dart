...
import 'package:hci_project/Screens/SubPages/edit_note_page.dart';
import 'package:hci_project/Screens/SubPages/note_detail_page.dart';
import 'package:hci_project/Services/Notes_Database.dart';
import 'package:hci_project/Widgets/note_card_widget.dart';
...
class _Notes extends State<Notes> {
  ...
  Future refreshNotes() async {
    ...
    this.notes = await NotesDatabase.instance.readAllNotes() as List<Note>;
